...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '254720736160';
            const dj2 = '254720736160';
            const dj3 = "254720736160";
            const luffy = '254720736160';
            const sudo = await getAllSudoNumbers();
            let goat = "254790599750";
...
zk.readMessages([ms.key]);
 ...
 //---------------------------------------rang-count--------------------------------
  ...
  try {
         ...
         console.log("lien detecté")
            var verifZokAdmin = verifGroupe ? admins.includes(idBot) : false;
             ...
             if(superUser || verifAdmin || !verifZokAdmin  ) { console.log('je fais rien'); return};
                         ...
                         if ( warn >= warnlimit) { 
                          var kikmsg = `link detected , you will be removed because you've reached warn-limit`;
                             ...
                             await zk.sendMessage(origineMessage, { delete: key });
                              ...
                              var  msg = `Link detected , your warn_count was upgraded ;\n rest : ${rest} `;
    ...
    let warnlimit = conf.WARN_COUNT
 if ( warn >= warnlimit) { 
  var kikmsg = `bot detected ;you will be removed because of using a bot here`;
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `*NYAMS-MD WELCOME MESSAGE*`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("✅ NYAMSL-MD HAS BEEN CONNECTED TO WHATSAPP! ☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("Nyams Md is Online 🕸\n\n");
                ...
                let cmsg =`
◆NYAMS-MD IS CONNECTED AND RUNNING◆
...
⁠`;
                ...
                if (raisonDeconnexion === baileys_1.DisconnectReason.badSession) {
                    console.log('Session id error, pair code again...');
                }
                    ...
                    console.log('you are disconnected,,, please create a new session ID');
                }
