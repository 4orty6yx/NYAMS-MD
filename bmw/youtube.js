...
zokou({
  ...
  if (!arg[0]) {
    repondre("sauti soul - Rhumba Japani ft Bensoul by sauti soul_");
    return;
  }
...
zokou({
  ...
  if (!arg[0]) {
    repondre("insert video name Ie. _video sauti soul - Rhumba Japani ft Bensoul by sauti soul._");
    return;
  }
...
\n\n\n NYAMS-MD`
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "NYAMS-MD", gifPlayback: false }, { quoted: ms });
      });
